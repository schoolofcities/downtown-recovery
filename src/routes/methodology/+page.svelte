...
<main>
    ...
    <div class="text">
        ...
        <p>
            Recovery metrics were computed on a weekly basis (using the ISO week number that it belongs to) and then averaged over the time periods noted on each chart.
        </p>

        <h2>January 2023 update:</h2>
