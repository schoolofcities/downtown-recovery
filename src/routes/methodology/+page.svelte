...
<main>
    ...
    <div class="text">
        ...
        <p>
            Click <a href="/downtowns-hbscan.geojson">here</a> to download a geojson file of the new downtown boundaries. Click <a href="/downtowns-original.geojson">here</a> to download a geojson file of our original zip-code defined downtowns. Click <a href="/downtown_definitions_2.pdf">here</a> to view a pdf of screenshots of the boundaries for each.
        </p>
